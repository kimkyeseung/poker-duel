        ...
        <div className={cn(compact ? 'space-y-2' : 'space-y-4')}>
          ...
          <div className={cn('flex items-center justify-between', compact ? 'gap-2' : 'gap-4')}>
            ...
            <div className={cn(
              ...
              <div className={cn('text-[#64748b]', compact ? 'text-xs' : 'text-sm mb-1')}>{t.game.labels.you}</div>
              ...
              {playerWinRate > 0 && (
                <div className={cn('text-[#ffd700] font-semibold', compact ? 'text-xs' : 'mt-2 text-sm')}>{t.results.winnerBadge}</div>
              )}
            </div>
            ...
            <div className={cn(
              ...
              <div className={cn('text-[#64748b]', compact ? 'text-xs' : 'text-sm mb-1')}>{t.game.labels.dealer}</div>
        ...
        <div className={cn(compact ? 'space-y-3' : 'space-y-6')}>
          ...
          <div className="flex items-center justify-between">
            <div className="text-center">
              <div className="text-xs text-[#64748b] uppercase mb-1">{t.game.labels.you}</div>
            ...
            <div className="text-center">
              <div className="text-xs text-[#64748b] uppercase mb-1">{t.game.labels.dealer}</div>
...
export function DetailedAnalysis({
  ...
  return (
    <div className={cn('game-card p-6', className)}>
      <h3 className="text-lg font-bold text-white mb-4">{t.results.detailedAnalysis}</h3>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#a0aec0] flex-1">{t.results.yourWins}</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#a0aec0] flex-1">{t.results.dealerWins}</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[#a0aec0] flex-1">{t.results.ties}</span>
        ...
        <div className="pt-3 border-t border-white/5">
          <div className="flex justify-between text-sm">
            <span className="text-[#64748b]">{t.results.totalCombinations}</span>
