...
export const fr: TranslationKeys = {
  ...
  practice: {
    ...
    modeRestriction: "* Les modes Expert et Dieu ne sont disponibles que dans le jeu principal",
  },
  ...
  game: {
    ...
    labels: {
      you: "VOUS",
      dealer: "CROUPIER",
      opponent1: "Adversaire 1",
      opponent2: "Adversaire 2",
  ...
  quotes: {
    ...
    king: [
      "Tu oses défier le trône du Roi !",
      "Survit ici et tu seras un vrai roi.",
      "Dans les 3%. Reste concentré.",
      "La couronne appartient au plus précis.",
    ],
    god: [
  ...
  leaderboard: {
    title: "Classement",
    notConfigured: "Classement non disponible",
    noEntries: "Aucun score pour le moment. Soyez le premier !",
    submitScore: "Soumettre Votre Score",
    yourName: "Votre Nom",
    namePlaceholder: "Entrez votre nom",
    nameRequired: "Le nom est obligatoire",
    submit: "Soumettre",
    submitted: "Score Soumis !",
    checkLeaderboard: "Consultez le classement pour voir votre rang !",
    rank: "Rang",
    player: "Joueur",
    chips: "Jetons",
    viewAll: "Voir Tout",
